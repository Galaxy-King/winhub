...
class Config:
    ...
    AI_MAX_HTTP_RESPONSE_BYTES = env_int('AI_MAX_HTTP_RESPONSE_BYTES', 4194304, 262144, 16777216)
    CODE_VALIDATOR_SOCKET = clean_env_value(os.environ.get('CODE_VALIDATOR_SOCKET')) or '/run/winhub-code-validator.sock'
